...
def get_text_message(message):
    ...
    if Menu.cur_menu != None and ms_text in Menu.cur_menu.buttons:
        if ms_text == "Помощь":
            ...
            bot.send_message(chat_id, text="Выберите район: \n"
                                           "/vas - 'Василеостровский район' \n"
                                           "/adm - 'Адмиралтейский район' \n"
                                           "/mosk - 'Московский район' \n"
                                           "/nev - 'Невский район' \n"
                                           "/petr - 'Петроградский район'")
        elif ms_text == "/vas":
            ...
            bot.send_message(chat_id, text="Выберите район: \n"
                                           "/vasr - 'Василеостровский район' \n"
                                           "/admr - 'Адмиралтейский район' \n"
                                           "/moskr - 'Московский район' \n"
                                           "/nevr - 'Невский район' \n"
                                           "/petrr - 'Петроградский район'")
        elif ms_text == "/vasr":
            ...
            bot.send_message(chat_id, text="Мне жаль, я не понимаю вашу команду: ")
