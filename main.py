...
def get_text_message(message):
    ...
    if ms_text == "Василеостровский район":
        ...
        place = random.choice(["https://avatars.mds.yandex.net/get-altay/2006773/2a0000016dc8b80b8f2435e6f4aadb04e798/XXL", "https://kayakspb.ru/wp-content/uploads/2016/11/repina_1.jpg", "https://pp.vk.me/c627417/v627417863/2d6c6/1JUJnG0knaA.jpg",
                 ...
                 "https://i11.fotocdn.net/s122/f262d1ab3ea21abe/public_pin_l/2785255158.jpg", "https://ic.pics.livejournal.com/classiks/23976823/512704/512704_original.jpg", "https://weatlas.com/img/landmarks/8dcee87215dcc73d6e3d3a70c1a623b6.jpg",
        ...
        bot.send_message(chat_id, text="Что это?")
        if place == "https://avatars.mds.yandex.net/get-altay/2006773/2a0000016dc8b80b8f2435e6f4aadb04e798/XXL":
            ...
            user_action = input("")
            bot.send_message(chat_id, text=user_action)
            ...
            #elif ms_text != "Сад Академии художеств" or ms_text != "Сад художеств" or ms_text != "сад академии художеств" or ms_text != "сад художеств" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Сад Академии художеств")
        elif place == "https://pp.vk.me/c627417/v627417863/2d6c6/1JUJnG0knaA.jpg":
            bot.send_photo(chat_id, 'https://pp.vk.me/c627417/v627417863/2d6c6/1JUJnG0knaA.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Египетские сфинксы" or ms_text == "египетские сфинксы" or ms_text == "сфинксы":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Египетские сфинксы" or ms_text != "египетские сфинксы" or ms_text != "сфинксы" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Египетские сфинксы")
        elif place == "https://topdialog.ru/wp-content/uploads/2019/04/tijgxpam1cw-e1556280752852.jpg":
            bot.send_photo(chat_id, 'https://topdialog.ru/wp-content/uploads/2019/04/tijgxpam1cw-e1556280752852.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Особняк Брусницыных" or ms_text == "особняк брусницыных" or ms_text == "особняк Брусницыных":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Особняк Брусницыных" or ms_text != "особняк брусницыных" or ms_text != "особняк Брусницыных" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Особняк Брусницыных")
        elif place == "https://fortuna-travel.ru/images/erarta-600-1.jpg":
            bot.send_photo(chat_id, 'https://fortuna-travel.ru/images/erarta-600-1.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Музей Эрарта" or ms_text == "музей эрарта" or ms_text == "музей Эрарта" or ms_text == "эрарта" or ms_text == "Эрарта":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Музей Эрарта" or ms_text != "музей эрарта" or ms_text != "музей Эрарта" or ms_text != "эрарта" or ms_text != "Эрарта" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Музей современного искусства Эрарта")
        elif place == "https://petersmonuments.ru/upload/iblock/e6b/e6bd118ce3fa0159d56722c25548fb97.jpg":
            ...
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Памятник бомбардиру Василию" or ms_text != "памятник бомбардиру василию" or ms_text != "памятник бомбардиру Василию" or ms_text != "памятник Василию" or ms_text != "памятник василию" or ms_text != "Памятник Василию" or ms_text != "Памятник василию" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Памятник бомбардиру Василию")
        elif place == "https://images.spasibovsem.ru/catalog/original/strelka-vasilevskogo-ostrova-sankt-peterburg-rossiya-otzyvy-1578937511.jpg":
            ...
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Стрелка Васильевского острова" or ms_text != "стрелка васильевского острова" or ms_text != "Стрелка васильевского острова" or ms_text != "стрелка Васильевского острова" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Стрелка Васильевского острова")
        elif place == "https://www.spbmuzei.ru/wp-content/uploads/2019/12/menshik2-1140x588.jpg":
            bot.send_photo(chat_id, 'https://www.spbmuzei.ru/wp-content/uploads/2019/12/menshik2-1140x588.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Дворец Меншикова" or ms_text == "дворец меншикова" or ms_text == "Дворец меншикова" or ms_text == "дворец Меншикова":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Дворец Меншикова" or ms_text != "дворец меншикова" or ms_text != "Дворец меншикова" or ms_text != "дворец Меншикова" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Дворец Меншикова")
        elif place == "https://kayakspb.ru/wp-content/uploads/2016/11/repina_1.jpg":
            bot.send_photo(chat_id, 'https://kayakspb.ru/wp-content/uploads/2016/11/repina_1.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Улица Репина" or ms_text == "улица Репина" or ms_text == "ул Репина" or ms_text == "Улица репина" or ms_text == "ул. Репина":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Улица Репина" or ms_text != "улица Репина" or ms_text != "ул Репина" or ms_text != "Улица репина" or ms_text != "ул. Репина" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Улица Репина")
        elif place == "https://petersburg24.ru/files/attachment_images/973_image.jpg?1531052667":
            bot.send_photo(chat_id, 'https://petersburg24.ru/files/attachment_images/973_image.jpg?1531052667')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Двор духов" or ms_text == "двор духов":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Двор духов" or ms_text != "двор духов" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Двор духов")
        elif place == "https://avatars.mds.yandex.net/get-altay/1545421/2a0000016eeeabe47a56138eeca259321201/XXL":
            ...
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Севкабель Порт" or ms_text != "Севкабель порт" or ms_text != "севкабель порт" or ms_text != "севкабель" or ms_text != "Севкабель" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Севкабель Порт")
        elif place == "https://n1s1.hsmedia.ru/8b/d9/40/8bd940ad98b075dadf3d57d523bce512/1000x667_0xac120003_15881333861615822925.jpg":
            bot.send_photo(chat_id, 'https://n1s1.hsmedia.ru/8b/d9/40/8bd940ad98b075dadf3d57d523bce512/1000x667_0xac120003_15881333861615822925.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Государственный Эрмитаж" or ms_text != "государственный эрмитаж" or ms_text != "Эрмитаж" or ms_text != "Государственный эрмитаж" or ms_text != "эрмитаж" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Государственный Эрмитаж")
        elif place == "https://photocentra.ru/images/main77/770044_main.jpg":
            bot.send_photo(chat_id, 'https://photocentra.ru/images/main77/770044_main.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Исаакиевский собор" or ms_text == "исаакиевский собор" or ms_text == "Исаакиевский" or ms_text == "исаакиевский":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Исаакиевский собор" or ms_text != "исаакиевский собор" or ms_text != "Исаакиевский" or ms_text != "исаакиевский" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Исаакиевский собор")
        elif place == "https://avatars.mds.yandex.net/get-zen_doc/1861837/pub_5df61efd8f011100ad77a72f_5df66ddf1e8e3f00acffb804/scale_1200":
            bot.send_photo(chat_id,'https://avatars.mds.yandex.net/get-zen_doc/1861837/pub_5df61efd8f011100ad77a72f_5df66ddf1e8e3f00acffb804/scale_1200')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Дворцовая площадь" or ms_text == "дворцовая площадь" or ms_text == "Дворцовая" or ms_text == "дворцовая":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Дворцовая площадь" or ms_text != "дворцовая площадь" or ms_text != "Дворцовая" or ms_text != "дворцовая" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Дворцовая площадь")
        elif place == "https://60wt.ru/upload/iblock/6a9/6a9127c167679bc5cbcd5c89d8af34f2.jpeg":
            bot.send_photo(chat_id, 'https://60wt.ru/upload/iblock/6a9/6a9127c167679bc5cbcd5c89d8af34f2.jpeg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Сенатская площадь" or ms_text == "сенатская площадь":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Сенатская площадь" or ms_text != "сенатская площадь" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Сенатская площадь")
        elif place == "https://cs12.pikabu.ru/post_img/big/2020/07/13/9/1594652562126321417.jpg":
            bot.send_photo(chat_id, 'https://cs12.pikabu.ru/post_img/big/2020/07/13/9/1594652562126321417.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Остров Новая Голландия" or ms_text != "Новая Голландия" or ms_text != "новая голландия" or ms_text != "Новая голландия" or ms_text != "остров новая голландия" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Остров Новая Голландия")
        elif place == "https://ksanytch.ru/Piter/OsobnyakRumyantseva.jpg":
            bot.send_photo(chat_id, 'https://ksanytch.ru/Piter/OsobnyakRumyantseva.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Особняк Румянцева" or ms_text == "особняк Румянцева" or ms_text == "особняк Румянцева" or ms_text == "Особняк румянцева":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Особняк Румянцева" or ms_text != "особняк Румянцева" or ms_text != "особняк Румянцева" or ms_text != "Особняк румянцева" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Особняк Румянцева")
        elif place == "https://peterburg.center/sites/default/files/9._st._petersburg._marble_palace.jpg":
            bot.send_photo(chat_id, 'https://peterburg.center/sites/default/files/9._st._petersburg._marble_palace.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Мраморный дворец" or ms_text == "мраморный дворец":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Мраморный дворец" or ms_text != "мраморный дворец" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Мраморный дворец")
        elif place == "https://sun6-23.userapi.com/impg/kiv0cita3Yhxit__OjtjhBD7zf8wReX0No12ew/zqwFzbs5CP4.jpg?size=697x582&quality=96&sign=ed24e08de8ce802047492ce182056ba3&c_uniq_tag=jNSJCSMugm3ZxqFenfkoNRDwPaARGbowdivSuBiq2GI&type=album":
            bot.send_photo(chat_id,'https://sun6-23.userapi.com/impg/kiv0cita3Yhxit__OjtjhBD7zf8wReX0No12ew/zqwFzbs5CP4.jpg?size=697x582&quality=96&sign=ed24e08de8ce802047492ce182056ba3&c_uniq_tag=jNSJCSMugm3ZxqFenfkoNRDwPaARGbowdivSuBiq2GI&type=album')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Владимирский дворец" or ms_text == "владимирский дворец":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Владимирский дворец" or ms_text != "владимирский дворец" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Владимирский дворец")
        elif place == "https://i02.fotocdn.net/s112/b1274b99ea2162de/public_pin_l/2522608915.jpg":
            bot.send_photo(chat_id, 'https://i02.fotocdn.net/s112/b1274b99ea2162de/public_pin_l/2522608915.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Адмиралтейство" or ms_text == "адмиралтейство":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Адмиралтейство" or ms_text != "адмиралтейство" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Адмиралтейство")
        elif place == "https://rogaine-spb.ru/wp-content/uploads/2019/02/2258695da86e048dce7bd8c62d157175.jpg":
            bot.send_photo(chat_id, 'https://rogaine-spb.ru/wp-content/uploads/2019/02/2258695da86e048dce7bd8c62d157175.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Московские Триумфальные ворота" or ms_text != "Московские триумфальные ворота" or ms_text != "московские триумфальные ворота" or ms_text != "Триумфальные ворота" or ms_text != "триумфальные ворота" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Московские Триумфальные ворота")
        elif place == "https://poisknews.ru/wp-content/uploads/2019/05/shutterstock_1098116876.jpg":
            bot.send_photo(chat_id, 'https://poisknews.ru/wp-content/uploads/2019/05/shutterstock_1098116876.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Пулковская обсерватория" or ms_text == "пулковская обсерватория":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Пулковская обсерватория" or ms_text != "пулковская обсерватория" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Пулковская обсерватория")
        elif place == "https://kikimoraki.ru/wp-content/uploads/2020/08/sovremennye-muzei-v-sankt-peterburge-chto-posetit-i-posmotret-1.jpg":
            bot.send_photo(chat_id,'https://kikimoraki.ru/wp-content/uploads/2020/08/sovremennye-muzei-v-sankt-peterburge-chto-posetit-i-posmotret-1.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Музей Гранд Макет Россия" or ms_text != "музей Гранд Макет Россия" or ms_text != "Гранд Макет Россия" or ms_text != "Гранд макет россия" or ms_text != "гранд макет россия" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Музей Гранд Макет Россия")
        elif place == "https://sdelanounas.ru/i/d/3/d/f_d3d3LmxlbnN2ZXQuc3BiLnJ1L2QvMjY5MDkvZC9wbG9zY2hhZC1wb2JlZHkuanBnP19faWQ9MTM2NDgw.jpeg":
            bot.send_photo(chat_id,'https://sdelanounas.ru/i/d/3/d/f_d3d3LmxlbnN2ZXQuc3BiLnJ1L2QvMjY5MDkvZC9wbG9zY2hhZC1wb2JlZHkuanBnP19faWQ9MTM2NDgw.jpeg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Площадь Победы" or ms_text == "Площадь победы" or ms_text == "площадь победы" or ms_text == "площадь Победы":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Площадь Победы" or ms_text != "Площадь победы" or ms_text != "площадь победы" or ms_text != "площадь Победы" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Площадь Победы")
        elif place == "https://i05.fotocdn.net/s108/5e6d346af19e01fc/public_pin_l/2383686541.jpg":
            bot.send_photo(chat_id, 'https://i05.fotocdn.net/s108/5e6d346af19e01fc/public_pin_l/2383686541.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Московский парк Победы" or ms_text != "московский парк победы" or ms_text != "Московский парк победы" or ms_text != "московский парк Победы" or ms_text != "Парк Победы" or ms_text != "Парк победы" or ms_text != "парк победы" or ms_text != "парк Победы" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Московский парк Победы")
        elif place == "https://upload.wikimedia.org/wikipedia/commons/7/7e/5238._St._Petersburg._Resurrection_Cathedral.jpg":
            bot.send_photo(chat_id, 'https://upload.wikimedia.org/wikipedia/commons/7/7e/5238._St._Petersburg._Resurrection_Cathedral.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Воскресенский Новодевичий Монастырь" or ms_text != "Воскресенский новодевичий монастырь" or ms_text != "воскресенский новодевичий монастырь" or ms_text != "Новодевичий монастырь" or ms_text != "новодевичий монастырь" or ms_text != "воскресенский монастырь" or ms_text != "Воскресенский монастырь" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Воскресенский Новодевичий монастырь")
        elif place == "https://i.travelapi.com/hotels/15000000/14820000/14815600/14815516/9410461b_z.jpg":
            bot.send_photo(chat_id, 'https://i.travelapi.com/hotels/15000000/14820000/14815600/14815516/9410461b_z.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Пулковский парк" or ms_text == "пулковский парк":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Пулковский парк" or ms_text != "пулковский парк" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Пулковский парк")
        elif place == "https://static.tildacdn.com/tild3939-6337-4535-b538-656434316461/faberge1.jpg":
            bot.send_photo(chat_id, 'https://static.tildacdn.com/tild3939-6337-4535-b538-656434316461/faberge1.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Музей Фаберже" or ms_text == "Музей фаберже" or ms_text == "музей фаберже" or ms_text == "Фаберже" or ms_text == "фаберже":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Музей Фаберже" or ms_text != "Музей фаберже" or ms_text != "музей фаберже" or ms_text != "Фаберже" or ms_text != "фаберже" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Музей Фаберже")
        elif place == "https://www.in4s.net/wp-content/uploads/2020/04/Ruski-muzej.jpg":
            bot.send_photo(chat_id, 'https://www.in4s.net/wp-content/uploads/2020/04/Ruski-muzej.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Михайловский дворец" or ms_text == "михайловский дворец":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Михайловский дворец" or ms_text != "михайловский дворец" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Михайловский дворец")
        elif place == "https://traveltimes.ru/wp-content/uploads/2021/08/2734040772.jpg":
            bot.send_photo(chat_id, 'https://traveltimes.ru/wp-content/uploads/2021/08/2734040772.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Казанский кафедральный собор" or ms_text != "казанский кафедральный собор" or ms_text != "Казанский собор" or ms_text != "казанский собор" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Казанский кафедральный собор")
        elif place == "https://sun9-38.userapi.com/impg/bZsnLjj5V9jL9qIjie59W88PdR0X4qvM2pNVbg/czpuVVOQDok.jpg?size=807x538&quality=96&sign=089b8281a0b0dd98e0542932e783aba5&c_uniq_tag=Mhb6xxrSU5JljiTViefoMZb6EUsJ9d149iPbcnfXix4&type=album":
            bot.send_photo(chat_id, 'https://sun9-38.userapi.com/impg/bZsnLjj5V9jL9qIjie59W88PdR0X4qvM2pNVbg/czpuVVOQDok.jpg?size=807x538&quality=96&sign=089b8281a0b0dd98e0542932e783aba5&c_uniq_tag=Mhb6xxrSU5JljiTViefoMZb6EUsJ9d149iPbcnfXix4&type=album')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Российский этнографический музей" or ms_text != "российский этнографический музей" or ms_text != "Этнографический музей" or ms_text != "этнографический музей" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Российский этнографический музей")
        elif place == "https://puzzleit.ru/files/puzzles/207/207272/_original.jpg":
            bot.send_photo(chat_id, 'https://puzzleit.ru/files/puzzles/207/207272/_original.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Михайловский замок" or ms_text == "Михайловский Замок" or ms_text == "михайловский замок":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Михайловский замок" or ms_text != "Михайловский Замок" or ms_text != "михайловский замок" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Михайловский Замок")
        elif place == "https://farm2.staticflickr.com/1819/44225802111_71ab67c29e_h.jpg":
            bot.send_photo(chat_id, 'https://farm2.staticflickr.com/1819/44225802111_71ab67c29e_h.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Летний сад" or ms_text == "летний сад":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Летний сад" or ms_text != "летний сад" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Летний сад")
        elif place == "https://aif-turkey.ru/800/600/http/s1.fotokto.ru/photo/full/444/4449040.jpg":
            bot.send_photo(chat_id, 'https://aif-turkey.ru/800/600/http/s1.fotokto.ru/photo/full/444/4449040.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Строгановский дворец" or ms_text == "строгановский дворец":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Строгановский дворец" or ms_text != "строгановский дворец" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Строгановский дворец")
        elif place == "https://perin-spb.ru/images/1.jpg":
            bot.send_photo(chat_id, 'https://i11.fotocdn.net/s122/f262d1ab3ea21abe/public_pin_l/2785255158.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Перинные ряды" or ms_text == "Арт-Центр в Перинных Рядах" or ms_text == "перинные ряды" or ms_text == "Арт-центр в Перинных рядах" or ms_text == "арт-центр в перинных рядах" or ms_text == "арт-центр в Перинных рядах":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Перинные ряды" or ms_text != "Арт-Центр в Перинных Рядах" or ms_text != "перинные ряды" or ms_text != "Арт-центр в Перинных рядах" or ms_text != "арт-центр в перинных рядах" or ms_text != "арт-центр в Перинных рядах" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Перинные Ряды")
        elif place == "https://ic.pics.livejournal.com/classiks/23976823/512704/512704_original.jpg":
            bot.send_photo(chat_id, 'https://ic.pics.livejournal.com/classiks/23976823/512704/512704_original.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Граффити Виктор Цой" or ms_text != "граффити Виктор Цой" or ms_text != "граффити виктор цой" or ms_text != "Граффити виктор цой" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Граффити Виктор Цой")
        elif place == "https://weatlas.com/img/landmarks/8dcee87215dcc73d6e3d3a70c1a623b6.jpg":
            bot.send_photo(chat_id, 'https://weatlas.com/img/landmarks/8dcee87215dcc73d6e3d3a70c1a623b6.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Набережная канала Грибоедова" or ms_text != "набережная канала Грибоедова" or ms_text != "Набережная канала грибоедова" or ms_text != "набережная канала грибоедова" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Набережная канала Грибоедова")
        elif place == "https://np-travel.spb.ru/assets/gallery/68/405.jpg":
            bot.send_photo(chat_id, 'https://np-travel.spb.ru/assets/gallery/68/405.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Петропавловская крепость" or ms_text == "петропавловская крепость":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Петропавловская крепость" or ms_text != "петропавловская крепость" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Петропавловская крепость")
        elif place == "https://i12.fotocdn.net/s105/7e73991d70a1cc11/public_pin_l/2242418389.jpg":
            bot.send_photo(chat_id, 'https://i12.fotocdn.net/s105/7e73991d70a1cc11/public_pin_l/2242418389.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Елагин остров" or ms_text == "елагин остров":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Елагин остров" or ms_text != "елагин остров" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Елагин остров")
        elif place == "https://forpost-sz.ru/sites/default/files/doc/2020/08/09/116906703_718768992297190_4461788238576538092_n.jpg":
            bot.send_photo(chat_id, 'https://forpost-sz.ru/sites/default/files/doc/2020/08/09/116906703_718768992297190_4461788238576538092_n.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Парк аттракционов Диво Остров" or ms_text != "парк аттракционов диво остров" or ms_text != "Диво Остров" or ms_text != " Диво остров" or ms_text != "диво остров" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Парк аттракционов Диво Остров")
        elif place == "https://cdn.spbdnevnik.ru/uploads/block/image/454986/__medium_selN-rfU_yg.jpg.jpg":
            bot.send_photo(chat_id, 'https://cdn.spbdnevnik.ru/uploads/block/image/454986/__medium_selN-rfU_yg.jpg.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Ботанический сад" or ms_text == "ботанический сад":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Ботанический сад" or ms_text != "ботанический сад" or ms_text != "":
               #bot.send_message(chat_id, text="Не угадали( \n Это Ботанический сад Петра Великого")
        elif place == "https://peterburg-blog.ru/wp-content/uploads/2017/01/домик-петра-первого-в-петербурге.jpg":
            bot.send_photo(chat_id, 'https://peterburg-blog.ru/wp-content/uploads/2017/01/домик-петра-первого-в-петербурге.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Домик Петра 1" or ms_text == "домик петра 1" or ms_text == "Домик петра 1" or ms_text == "домик Петра 1":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Домик Петра 1" or ms_text != "домик петра 1" or ms_text != "Домик петра 1" or ms_text != "домик Петра 1" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Домик Петра 1")
        elif place == "https://cat-cat-cat.ru/photo/2015/01/MG_5398-2-.jpg":
            bot.send_photo(chat_id, 'https://cat-cat-cat.ru/photo/2015/01/MG_5398-2-.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Александровский парк" or ms_text == "александровский парк" or ms_text == "Александровский Парк":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Александровский парк" or ms_text != "александровский парк" or ms_text != "Александровский Парк" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Александровский парк")
        elif place == "https://www.visit-petersburg.ru/upload/iblock/429/00kwgh5t7ake3i8pg89jppgrb09am35z/1696_cover.jpg":
            bot.send_photo(chat_id, 'https://www.visit-petersburg.ru/upload/iblock/429/00kwgh5t7ake3i8pg89jppgrb09am35z/1696_cover.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
                ...
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Приморский парк Победы" or ms_text != "Приморский парк победы" or ms_text != "приморский парк победы" or ms_text != "приморский парк Победы" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Приморский парк Победы")
        elif place == "https://korona-severa.ru/wp-content/uploads/c/5/b/c5ba1c822cac2a2a851b8432c2838ece.jpeg":
            bot.send_photo(chat_id, 'https://korona-severa.ru/wp-content/uploads/c/5/b/c5ba1c822cac2a2a851b8432c2838ece.jpeg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Петровская набережная" or ms_text == "петровская набережная":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Петровская набережная" or ms_text != "петровская набережная" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Петровская набережная")
        elif place == "https://sun9-40.userapi.com/bWQbmy9CcjGfSQ3o_4tKlhJiD5W_jLqaVwC1og/54IESpfAAcw.jpg":
            bot.send_photo(chat_id, 'https://sun9-40.userapi.com/bWQbmy9CcjGfSQ3o_4tKlhJiD5W_jLqaVwC1og/54IESpfAAcw.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Лопухинский сад" or ms_text == "лопухинский сад":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Лопухинский сад" or ms_text != "лопухинский сад" or ms_text != "":
                #bot.send_message(chat_id, text="Не угадали( \n Это Лопухинский сад")
        elif place == "https://s00.yaplakal.com/pics/pics_original/6/6/1/10239166.jpg":
            bot.send_photo(chat_id, 'https://s00.yaplakal.com/pics/pics_original/6/6/1/10239166.jpg')
            user_action = input()
            bot.send_message(chat_id, text=user_action)
            #if ms_text == "Каменностровский проспект" or ms_text == "каменностровский проспект":
                #bot.send_message(chat_id, text="Правильно!")
            #elif ms_text != "Каменностровский проспект" or ms_text != "каменностровский проспект" or ms_text != "":
