...
def send_picture(chat_id, ms_text):
    if ms_text == "Картина":
        ...
        if place == 'https://pp.vk.me/c627417/v627417863/2d6c6/1JUJnG0knaA.jpg':
            if ms_text == "Египетские сфинксы" or ms_text == "египетские сфинкусы" or ms_text == "сфинксы":
                bot.send_message(chat_id, text="Правильно!")
            else:
        ...
        if place == 'https://perin-spb.ru/images/1.jpg':
            if ms_text == "Арт-Центр в Перинных Рядах" or ms_text == "Арт-центр в перинных рядах" or ms_text == "Арт-центр в Перинных рядах" or ms_text == "арт-центр в перинных рядах" or ms_text == "арт-центр в Перинных рядах":
                bot.send_message(chat_id, text="Правильно!")
            else:
                bot.send_message(chat_id, text="Не угадали( \n Это Арт-Центр в Перинных Рядах")
        ...
        if place == 'https://cdn.spbdnevnik.ru/uploads/block/image/454986/__medium_selN-rfU_yg.jpg.jpg':
            if ms_text == "Ботанический сад Петра Великого" or ms_text == "ботанический сад петра великого" or ms_text == "Ботанический сад" or ms_text == "ботанический сад" or ms_text == "Ботанический сад петра великого":
                bot.send_message(chat_id, text="Правильно!")
            else:
