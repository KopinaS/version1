...
def get_text_messages(message):
    ...
    if ms_text == "Главное меню" or ms_text == "👋🏻 Главное меню" or ms_text == "Вернуться в главное меню":
        ...
        bot.send_message(chat_id, text="🧇*Брюгге*(Бельгийская кухня, Бар) - Набережная Макарова, 22\n\n"
                                       ...
                                       "🍱*Пельмения на Среднем*(Азиатская кухня, Русская кухня) - Средний пр. В.О., 11", parse_mode="Markdown")
        ...
        bot.send_message(chat_id, text="🥐*FULL HOUSE Grill-Bar*(Европейская кухня, бар) - Наб. Канала Грибоедова, 27\n\n"
                                       ...
                                       "🥐*Вайн Гог*(Европейская кухня, винный бар) - Малая Конюшенная, 7", parse_mode="Markdown")
        ...
        bot.send_message(chat_id, text="🍝*Капулетти*(Итальянская кухня) -Большой проспект П.С., д. 74\n\n"
                                       ...
                                       "🧇*Маннекен Пис*(Бельгийская кухня, Европейская кухня) - Каменноостровский проспект, 12", parse_mode="Markdown")
